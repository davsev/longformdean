                                    ...
                                    <div class="x_content">
                                        <div class="row">
                                            <div class="col-md-4 col-md-pull-2 col-sm-12 mb-3">
                                                ...
                                                <input type="text" name="fname" class="form-control" id="fname" autocomplete='first-name' readonly placeholder="" required="" value="<?php echo ($Form->fname ? $Form->fname : ((isset($_GET['fname']) ? $_GET['fname'] : 'נא להזין ערך'))) ; ?>">
                                            ...
                                            <div class="col-md-4 col-md-pull-2  col-sm-12 mb-3">
                                                ...
                                                <input type="text" name="lname" class="form-control" id="lname" readonly placeholder="" required="" value="<?php echo ($Form->lname ? $Form->lname : ((isset($_GET['lname']) ? $_GET['lname'] : 'נא להזין ערך'))) ; ?>"
                                ...
                                <div class="x_panel" id="family-income">
                                    ...
                                    <div class="x_content">
                                        <div class="row hidden" id="is_siua_cont">
                                            <div class="col-md-8 col-md-pull-2 col-sm-12 mb-3">
                                                <label>מקבל סיוע<span class="red">*</span></label>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-8 col-md-pull-2 col-sm-12 mb-3" id="taasukati_zug_state_cont">
                                                    ...
                                                    <select name="taasukati_zug_state" class="taas form-control" id="taasukati_zug_state">
                                                        ...
                                                        <option value="3" <?php echo($Form->taasukati_zug_state == '3' ? 'selected' : '')?>>לא עובד/ת</option>
                                                    </select>
                                                </div>
                                            </div>
...
<div class="col-md-8 col-md-pull-2 col-sm-12 mb-3 hidden" id="self_children_files_cont">
                        <div class="custom-file" id="self_children_files_div">
                            ...
                            <input type="file" class="custom-file-input alwaysRequired" id="self_children_files" name="self_children_files" />
...
<div class="col-md-8 col-md-pull-2 col-sm-12 mb-3" id="self_soldier_files_cont">
                        <div class="custom-file" id="self_soldier_files_div">
                            ...
                            <input type="file" class="custom-file-input alwaysRequired" id="self_soldier_files" name="self_soldier_files" />
...
<div class="col-md-8 col-md-pull-2 col-sm-12 mb-3" id="self_student_files_cont">
                        <div class="custom-file" id="self_student_files_div">
                            <label class="custom-file-label" for="self_student_files">
                                אם כן חייב בהעלאת אישור לימודים<span class="red">*</span>
                            </label>
                            ...
                            <input type="file" class="custom-file-input alwaysRequired" id="self_student_files" name="self_student_files" />
                        </div>
                    </div>
