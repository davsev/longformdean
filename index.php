    ...
    <body>
      ...
      <div class="py-5 text-right">
        ...
        <p class="lead">        תאריך אחרון להגשה: 31.10.2018
          <br />
        תשובה תשלח בדואר כחודשיים לאחר תחילת שנת הלימודים
        </p>
        <p class="lead">
        לנוחיותך, מצורפת רשימת מסמכים נדרשים.  <br />
לתשומת ליבך: סטודנט רווק יצרף מסמכי הורים ואחים, סטודנט נשוי יצרף מסמכי בת זוג וילדים.  <br />
מומלץ לוודא שיש ברשותך מסמכים נדרשים לפני תחילת התהליך.  <br />
טופס בקשה אשר יוגש ללא כל המסמכים הנדרשים לא יקלט במערכת ולא יטופל.
        </p>
        ...
        <div class="row">
          ...
          <div class="col-md-12 mb-3">
            ...
            <select class="custom-select" name="study_year" id="study_year" required>    
                ...
                <option value="ד"  <?php echo($Form->study_year == 'ד' ? 'selected' : '')?>>ד</option>
            </select>
          </div>
        </div>
        <div class="row">
